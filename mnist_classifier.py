...
# plt.semilogy(x_axis, np.abs(y1_axis - y1_axis[len(y_axis)-1]), 'orange', label='Test data')
...
# plt.semilogy(x_axis, np.abs(y_axis - y_axis[len(y_axis)-1]), 'blue', label='Train data')
# plt.semilogy(x1_axis, np.abs(y1_axis - y1_axis[len(y1_axis)-1]), 'orange', label='Test data')
...
# x1_axis, y1_axis = gradient_descent(A_test, w, 1 - y_test_filtered)
# plt.semilogy(x_axis, np.abs(y_axis - y_axis[len(y_axis)-1]), 'blue', label='Train data')
# plt.semilogy(x1_axis, np.abs(y1_axis - y1_axis[len(y_axis)-1]), 'orange', label='Test data')
# #
# Newton
...
x1_axis, y1_axis = newton(A_test, w, 1 - y_test_filtered)
plt.semilogy(x_axis, np.abs(y_axis - y_axis[len(y_axis)-1]), 'blue', label='Train data')
plt.semilogy(x1_axis, np.abs(y1_axis - y_axis[len(y1_axis)-1]), 'orange', label='Test data')
